...
function DarkPinkMainPage() {
  const InitialData = {
    about: {
      name: "Ram Jaanu",
      titleName: "Fashion Designer",
      description:
        "Experienced software dsoftware Lorem ctetur adipisicing elit. Veniam reprehenderit repellat odit expedita soluta molestiae numquam, rem esse, repellendus, maiores nulla architecto facilis? Hic rem repellendus reiciendis sint recusandae quae. develope ",
      profile:
        "https://static.vecteezy.com/system/resources/previews/012/681/670/original/girl-shy-cartoon-cute-kawaii-anime-illustration-clipart-character-chibi-drawing-manga-png.png",
...
export default DarkPinkMainPage;
