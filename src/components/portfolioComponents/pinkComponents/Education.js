    ...
    return educationData.map((data, index) =>
      index % 2 === 0 ? (
        <div key={data._id} className="mt-5 w-full flex justify-start animate-child">
          <div className=" w-full md:w-7/12  rounded-2xl mx-5 border border-pink-300 hover:border-pink-300 px-6 py-2 shadow-md shadow-pink-200 hover:shadow-pink-300">
            <div className="flex mx-auto justify-between">
              ...
              <svg
                ...
                strokeWidth={1.5}
                stroke="currentColor"
                className="w-8 h-8 text-slate-700 hover:text-pink-400"
              >
                <path
                  strokeLinecap="round"
    ...
    <div className=" mt-20 block sm:flex w-11/12 md:w-4/5 mx-auto">
      ...
      <div className="w-full md:w-4/6 mx-auto md:pl-10 h-96">
        <div className="flex items-end justify-end">
          <h1 className="w-3/5 md:w-3/5  text-blue-500 text-end mt-5 pb-2 text-xl font-bold border-b-2 border-pink-100">
            Education
          </h1>
        </div>
