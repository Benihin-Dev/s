...
function YellowDarkMainPage() {
  const InitialData = {
    about: {
      ...
      profile:
        "https://snapfolioprofilepics.s3.amazonaws.com/9e49236139f2f8237baabc71aacda936.png",
...
export default YellowDarkMainPage;
