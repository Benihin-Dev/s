  ...
  return (
    <div className="w-full mb-5 md:mb-10 items-center">
      <div className="flex justify-center items-center ">
        <h1 className="w-4/5 md:w-2/5 h-5 mt-2 md:mt-10 border-b-2 border-yellow-200"></h1>
      </div>
        ...
        <div className="w-11/12 sm:w-4/5 flex items-center mx-auto mt-5 h-96">
          <div className=" w-full md:w-4/6">
            <ul className="flex justify-center w-full mx-auto mt-5 md:mt-10 gap-10 items-center md:w-4/5 ">
              <li
                ...
                className={`${
                  selecteditem === 2
                    ? "text-slate-300 hover:text-yellow-400 text-xl font-bold border-b-2 border-yellow-500"
          ...
          <div className=" hidden md:w-2/6  md:flex justify-center ">
            <svg
              ...
              strokeWidth={1.5}
              stroke="currentColor"
              className="md:w-40 w-6 hoverdance text-slate-50"
            >
              <path
                strokeLinecap="round"
