          ...
          <div className=" w-full flex justify-end">
            <div className="w-full sm:w-11/12 sm:grid-cols-2  sm:grid h-96 overflow-x-hidden overflow-y-scroll experienceComponent">
              {experienceData.map((data,index) => (
                <div key={index} className="w-11/12 rounded-2xl my-4 md:mx-5 border md:min-h-24 md:max-h-52 overflow-hidden hover:border-slate-400 border-purple-200 shadow-lg pb-2 sm:pb-8 hover:shadow-purple-300">
