...
function GreenDarkMainPage() {
  const InitialData = {
    about: {
      ...
      description:
        "Experienced software dsoftware Logn consectetur adipisicing elit. Veniam reprehenderit repellat odit expedita soluta molestiae numquam, rem esse, repellendus, maiores nulla architecto facilis? Hic rem repellendus reiciendis sint recusandae quae. develope ",
      profile:
        "https://snapfolioprofilepics.s3.amazonaws.com/79bf62766b8bdc8c2ac61b983bba25be.png",
  ...
  return (
    <div className="font-kanit mainBodyDarkGreen  overflow-hidden">
      {/* <button
