  ...
  return (
    <div className="w-full mb-5 md:mb-10 items-center">
      <div className="flex justify-center items-center ">
        <h1 className="w-4/5 md:w-2/5 h-5 mt-2 md:mt-10 border-b-2 border-green-300"></h1>
      </div>
          ...
          <div className=" w-full md:w-4/6">
            <ul className="flex justify-center w-full mx-auto mt-5 md:mt-10 gap-10 items-center md:w-4/5 ">
              <li
                ...
                className={`${
                  selecteditem === 2
                    ? "text-green-300 hover:text-green-600 text-xl font-bold border-b-2 border-green-500"
              ...
              <li
                ...
                className={`${
                  selecteditem === 1
                    ? "text-green-300 hover:text-green-800 text-xl font-bold border-b-2 border-green-500"
                    : "text-green-300 text-xl font-bold"
                }  `}
              >
                Projects
