    ...
    <div className="fixed top-0 left-0 right-0 shadow-md md:shadow-none  opacity-90 sm:opacity-100 rounded-2xl sm:bg-transparent z-10 block md:flex  w-4/5 mx-auto mt-5 justify-between items-center">
      <div className="flex mr-2 items-center justify-between">
          <img
            ...
            className="navBarImg size-9 border hover:border-purple-700 border-purple-400 items-start  rounded-full  flex justify-center overflow-hidden"
          />
        ...
        <div className="block md:hidden">
          {value === false ? (
            <svg
              ...
              strokeWidth={1.5}
              stroke="currentColor"
              className="w-6 h-6 cursor-pointer text-green-600 hover:text-black"
            >
              <path
                strokeLinecap="round"
