...
function GreenMainPage() {
  const InitialData = {
    about: {
      name: "Juliana Rose",
      titleName: "Software Engineer",
      description:
        "Experienced software dsoftware sit amet consectetur adipisicing elit. Veniam reprehenderit repellat odit expedita soluta molestiae numquam, rem esse, repellendus, maiores nulla architecto facilis? Hic rem repellendus reiciendis sint recusandae quae. develope ",
      profile:
        "https://snapfolioprofilepics.s3.amazonaws.com/f9998af75d33c04c802a18fdf806d408.png",
  ...
  return (
    <div className="font-kanit mainPageGreen overflow-hidden">
      {/* <button
