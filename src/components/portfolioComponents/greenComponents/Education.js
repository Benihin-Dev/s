          ...
          <div className=" w-full md:w-7/12  rounded-2xl mx-5 border border-green-300 hover:border-green-500 px-6 py-2 shadow-md shadow-purple-200 hover:shadow-purple-300">
            <div className="flex mx-auto justify-between">
              <div>
                ...
                <h2 className=" text-xs text-purple-600">{data.place}</h2>
              </div>
              <svg
                ...
                strokeWidth={1.5}
                stroke="currentColor"
                className="w-8 h-8 text-slate-700 hover:text-green-800"
              >
                <path
                  strokeLinecap="round"
          ...
          <div className=" w-full md:w-7/12  rounded-2xl mx-5 border border-green-300 hover:border-green-500 px-6 py-2 shadow-md shadow-purple-200 hover:shadow-purple-300">
            <div className="flex mx-auto justify-between">
              ...
              <svg
                ...
                strokeWidth={1.5}
                stroke="currentColor"
                className="w-8 h-8 text-slate-700 hover:text-green-500"
              >
                <path
                  strokeLinecap="round"
                  strokeLinejoin="round"
    ...
    <div className=" mt-20 block sm:flex w-11/12 md:w-4/5 mx-auto">
      <div className="w-full flex items-center justify-around mt-2 md:mt-16 relative md:w-2/6">
        <div className="flex-col ">
          <svg
            ...
            viewBox="0 0 24 24"
            fill="currentColor"
            className="w-8 sm:w-10 right-48 sm:right-20 absolute moment text-purple-500"
          >
            <path
              fillRule="evenodd"
          ...
          <svg
            ...
            strokeWidth={1.5}
            stroke="currentColor"
            className="absolute left-40 sm:left-10 top-16 rocketmoment w-12 sm:w-20  text-green-400"
          >
            <path
              strokeLinecap="round"
              strokeLinejoin="round"
      ...
      <div className="w-full md:w-4/6 mx-auto md:pl-10 h-96">
        <div className="flex items-end justify-end">
          <h1 className="w-3/5 md:w-3/5  text-green-500 hover:text-green-500 text-end mt-5 pb-2 text-xl font-bold border-b-2 border-green-100">
            Education
          </h1>
        </div>
