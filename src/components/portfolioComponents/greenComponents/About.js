    ...
    <div className="block sm:flex w-4/5 mt-12 mx-auto md:mt-5 overflow-hidden">
      ...
      <div className="w-full aboutUser upFromDown mt-1 mt sm:mt-12 md:mt-32  lg:mt-48 xl:mt-64 sm:pl-6 md:w-7/12 ">
        ...
        <h1 className="text-4xl md:text-5xl ">
          I'm{" "}
          <span className="name text-[#37ba77] tracking-normal">
            {aboutData.name}{" "}
          </span>
          <p className=" text-lg sm:text-2xl p-0 text-purple-500 tracking-widest">
            {" "}
            <ReactTyped
        ...
        <div className="mt-2 sm:mt-1  flex justify-end items-center">
          <a href={aboutData.cv}>
            <button className=" border rounded-2xl border-green-400 hover:bg-green-400  text-slate-600 hover:text-white text-xs sm:text-normal py-1 px-3">
              Download CV
            </button>
          </a>
        </div>
