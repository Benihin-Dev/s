...
function WhiteDarkMainPage() {
  const InitialData = {
    about: {
      name: "Jenifer Lowrence",
      ...
      profile:
        "https://snapfolioprofilepics.s3.amazonaws.com/c103e4053274c4d886f585ea4111d28f.png",
  ...
  return (
    <div className="font-kanit mainBodyDarkWhite overflow-hidden">
      {/* <button
...
export default WhiteDarkMainPage;
